...
> 
> Um dies dennoch möglich zu machen, könnte das Kommando `chmod 755 ~` hilfreich sein.
...
>[!NOTE]
> Alle Aufgaben hier sollen mit dem User ausgeführt werden, der der *Besitzer* bzw. *Owner* der Datei/des Verzeichnisses ist.
